...
INSERT INTO factsongplays (start_time, userId, level, song_id, artist_id,
                           sessionId, location, userAgent)
SELECT DISTINCT timestamp 'epoch' + e.ts * interval '0.001 seconds'
       as start_time,
       e.userId,
       e.level,
       s.song_id,
...
artist_table_insert = ("""
INSERT INTO dimartists (artist_id, artist_name, artist_location,
